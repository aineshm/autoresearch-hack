...
function RunHeaderCard({ data }) {
  const { runId, metric, lowerIsBetter, best, generations, counts, experiments } = data;
  const bestLabel = best !== null && best !== undefined
    ? best.toFixed(6)
    : null;
